...
<pre>
                        ...
                        insured_name:   <input type="text"name="insured_name">
            
   			insured_street: <input type="text"name="insured_street">
   			
  		        insured_city:   <input type="text" name="insured_city">
  		    
                        insured_state:  <input type="text" id="Text1"  name="insured_state">
            
                        insured_zip:    <input type="text" id="Text1"  name="insured_zip">
				    ...
				    User_name:    <input type="text" id="Text1"  name="username">
